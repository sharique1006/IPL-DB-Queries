...
\copy batting_style from 'IPL DB/batting_style.csv' delimiter ',' csv header;
\copy bowling_style from 'IPL DB/bowling_style.csv' delimiter ',' csv header;
\copy out_type from 'IPL DB/out_type.csv' delimiter ',' csv header;
\copy outcome from 'IPL DB/outcome.csv' delimiter ',' csv header;
\copy country from 'IPL DB/country.csv' delimiter ',' csv header;
\copy role from 'IPL DB/role.csv' delimiter ',' csv header;
\copy team from 'IPL DB/team.csv' delimiter ',' csv header;
\copy win_by from 'IPL DB/win_by.csv' delimiter ',' csv header;
\copy player from 'IPL DB/player.csv' delimiter ',' csv header;
\copy season from 'IPL DB/season.csv' delimiter ',' csv header;
\copy match from 'IPL DB/match.csv' delimiter ',' csv header;
\copy player_match from 'IPL DB/player_match.csv' delimiter ',' csv header;
\copy ball_by_ball from 'IPL DB/ball_by_ball.csv' delimiter ',' csv header;
\copy batsman_scored from 'IPL DB/batsman_scored.csv' delimiter ',' csv header;
\copy wicket_taken from 'IPL DB/wicket_taken.csv' delimiter ',' csv header;